...
const renderRoot = () => {
    ...
    const headingWithChild = React.createElement("h1", {}, React.createElement("span", {id: "heading", style: {color: "green"}}, "Hello World using React with Child!!"));

    // creating an react element (object) with a child with CSS Class
    const headingWithChildCSS = React.createElement("h1", {}, React.createElement("span", {id: "heading", className: "heading"}, "Hello World using React with Child and CSS class!!"));
     ...
     *  </div>
    */
    const structured_el = React.createElement("div", { id: "parent" },
        React.createElement("div", { id: "child" }, 
            React.createElement("h1", { id: "child-heading" }, 
                React.createElement("span", { className: "structure"}, "Hello World using React with defined structure")
            )
        )
    );
     ...
     *  </div>
    */
    const structured_el2 = React.createElement("div", { id: "parent" },
        React.createElement("div", { id: "child" }, [
            React.createElement("h1", { id: "child-heading-1" }, 
                React.createElement("span", { className: "structure-sibling-1"}, "Hello World using React with 1st Sibling")
            ),
            React.createElement("h1", { id: "child-heading-2" }, 
                React.createElement("span", { className: "structure-sibling-2"}, "Hello World using React with 2nd Sibling")
            )
        ])
    );
